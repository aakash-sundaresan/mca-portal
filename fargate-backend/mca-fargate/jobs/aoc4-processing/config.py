...
PROCESSED_PREFIX = os.environ.get('PROCESSED_PREFIX', 'aoc4/processed/')
FAILED_PREFIX = os.environ.get('FAILED_PREFIX', 'aoc4/failed/')
JSON_OUTPUT_PREFIX = os.environ.get('JSON_OUTPUT_PREFIX', 'aoc4/json/')
